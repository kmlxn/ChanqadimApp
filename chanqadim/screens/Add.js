...
export default class Add extends Component {
  ...
  async addBundle () {
    ...
    if (bundle) { Actions.bundle({bundle}) }
  }
  ...
  renderProduct () {
    ...
    return <View style={{flex: 1}}>
      <TextInput underlineColorAndroid={theme.textInputBottomColor} placeholder='Name'
        onChangeText={name => this.setState({name})} />
      <TextInput underlineColorAndroid={theme.textInputBottomColor} placeholder='Description'
        onChangeText={description => this.setState({description})} />
      <TextInput underlineColorAndroid={theme.textInputBottomColor} placeholder='Price'
